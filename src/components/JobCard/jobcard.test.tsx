...
const jobData = {
    "companyUrl": "https://assets.ccbp.in/frontend/react-js/jobby-app/netflix-img.png",
...
describe("Job Card component Tests", () => {
    it("Job Role", () => {
        const { getByText } = render(<JobCard jobData={jobData} />, { wrapper: routerWrapper })
        const element = getByText("Internship")
        expect(element).toBeInTheDocument()
    })

    it("JobCard Logo", () => {
        const { getByTestId } = render(<JobCard jobData={jobData} />, { wrapper: routerWrapper })
